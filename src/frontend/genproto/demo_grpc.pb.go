...
type ChatbotServiceClient interface {
	GetChatbotMessage(ctx context.Context, in *ChatbotRequest, opts ...grpc.CallOption) (*ChatbotResponse, error)
}
...
func (c *chatbotServiceClient) GetChatbotMessage(ctx context.Context, in *ChatbotRequest, opts ...grpc.CallOption) (*ChatbotResponse, error) {
	out := new(ChatbotResponse)
	err := c.cc.Invoke(ctx, "/hipstershop.ChatbotService/getChatbotMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatbotServiceServer interface {
	GetChatbotMessage(context.Context, *ChatbotRequest) (*ChatbotResponse, error)
...
func (UnimplementedChatbotServiceServer) GetChatbotMessage(context.Context, *ChatbotRequest) (*ChatbotResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetChatbotMessage not implemented")
}
...
func _ChatbotService_GetChatbotMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChatbotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatbotServiceServer).GetChatbotMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hipstershop.ChatbotService/getChatbotMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatbotServiceServer).GetChatbotMessage(ctx, req.(*ChatbotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatbotService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.ChatbotService",
	HandlerType: (*ChatbotServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getChatbotMessage",
			Handler:    _ChatbotService_GetChatbotMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
