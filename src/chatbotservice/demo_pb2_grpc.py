...
class ChatbotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.getChatbotMessage = channel.unary_unary(
                '/hipstershop.ChatbotService/getChatbotMessage',
                request_serializer=demo__pb2.chatbotRequest.SerializeToString,
                response_deserializer=demo__pb2.chatbotResponse.FromString,
                )
...
def add_ChatbotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getChatbotMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.getChatbotMessage,
                    request_deserializer=demo__pb2.chatbotRequest.FromString,
                    response_serializer=demo__pb2.chatbotResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.ChatbotService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ChatbotService(object):
    ...
    def getChatbotMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.ChatbotService/getChatbotMessage',
            demo__pb2.chatbotRequest.SerializeToString,
            demo__pb2.chatbotResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
