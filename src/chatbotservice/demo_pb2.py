...
_CHATBOTREQUEST = _descriptor.Descriptor(
  name='chatbotRequest',
  full_name='hipstershop.chatbotRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='hipstershop.chatbotRequest.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='hipstershop.chatbotRequest.user_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CHATBOTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='hipstershop.chatbotResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='hipstershop.chatbotResponse.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='product_ids', full_name='hipstershop.chatbotResponse.product_ids', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
chatbotRequest = _reflection.GeneratedProtocolMessageType('chatbotRequest', (_message.Message,), {
  ...
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.chatbotRequest)
  })
...
chatbotResponse = _reflection.GeneratedProtocolMessageType('chatbotResponse', (_message.Message,), {
  ...
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.chatbotResponse)
  })
...
_CHATBOTSERVICE = _descriptor.ServiceDescriptor(
  name='ChatbotService',
  full_name='hipstershop.ChatbotService',
  file=DESCRIPTOR,
  index=9,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  methods=[
  _descriptor.MethodDescriptor(
    name='getChatbotMessage',
    full_name='hipstershop.ChatbotService.getChatbotMessage',
    index=0,
    containing_service=None,
